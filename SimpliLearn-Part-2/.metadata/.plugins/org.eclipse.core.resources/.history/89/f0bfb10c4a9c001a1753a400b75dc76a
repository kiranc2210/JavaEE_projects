...
<div class="helpclass">
      ...
      <div class="tab-content">
        ...
        <div id="menu1" class="tab-pane fade">
          ...
          <p>In the left navigation bar, click on <mark>'Manage student'</mark> link. A Table will be appeared which you can filter &amp; search specific student student by <b>student id</b>. After search the relevent student, click on the table cells to update information and click on the red 'X' icon to delete record.</p>
        </div>
        ...
        <div id="menu3" class="tab-pane fade">
          ...
          <p>In the left navigation bar, click on <mark>'Manage Teachers'</mark> link. A Table will be appeared which you can filter &amp; search specific teachers by <b>teacher id</b> and manage them.</p>
        </div>
