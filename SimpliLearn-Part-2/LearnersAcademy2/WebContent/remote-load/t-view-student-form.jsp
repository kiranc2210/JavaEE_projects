...
<p>Click on student id in marks colomn to add marks</p>
<p>Click on Student name to view details</p>
...
<c:forEach items="${studList}" var="student">
		<tr>
			<td>
				<!--<a href="StudentController?by=teacher&student_id=${student.student_id}">-->
			...
			<a href="./MarksController?by=teacher-v&s_id=${student.student_id}">
			<span class="label label-warning"><u>${student.student_id}</u></span>
			</a>
			
			<!-- 
			<a href="./MarksController?student_id=${student.student_id}">
			<span class="label label-warning"><u>${student.student_id}</u></span>
			</a>
			 -->
			</td>
