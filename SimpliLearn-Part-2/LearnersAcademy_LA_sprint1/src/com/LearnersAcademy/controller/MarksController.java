...
public class MarksController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String r_by = "";
		if (request.getParameter("by") != null && request.getParameter("by") != "" && request.getParameter("s_id") != ""
				&& request.getParameter("s_id") != null) {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("post") != null) {
			...
			if (post.equalsIgnoreCase("add")) {
				...
				markbn.setKannada(request.getParameter("kannada"));
				markbn.setEnglish(request.getParameter("english"));
				markbn.setHindi(request.getParameter("hindi"));
